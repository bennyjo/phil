...
Rules (v1, 2026-09-02):
  ...
  4. Spread (ask - bid) <= 0.06, the risk.json cap: a wide book means the
     recorded ask is not a real price.
  5. Flat $5 stake. Edge-scaled sizing lowered the held-out score.

Replay (5 folds, 420 settled rows, 336 held out): cw_return +0.239,
pnl +92.93 on 29 bets, brier_delta -0.0097. 10 folds: +0.155.
...
the pnl; excluding them the held-out roi is still positive (~+0.14).
"""
